...
test_that("validate_score works", {
  ...
  validate_score("Linear",
    ...
    expect_equal(tibble::tibble_row(
      score_type = "Linear", colname = "x",
...
test_that("edit_row works", {
  edit_row(
    tibble::tibble(x = 1, y = 1), tibble::tibble(x = 1),
    NULL
  ) %>%
...
test_that("create_score works", {
  ...
  create_score(scores_with_scores,
    editing = NA, score_type = "Linear", colname = "x",
    score_name = "a", weight = 2, lb = 1, ub = 2,
    exponential = FALSE
  ) %>%
    expect_equal(tibble::add_row(scores_with_scores,
      score_type = "Linear", colname = "x",
      score_name = "a", weight = 2, lb = 1, ub = 2,
      exponential = F
    ))
  create_score(scores_with_scores,
    editing = 2, score_type = "Peak", colname = "x",
  ...
  # editing > nrow(scores)
  create_score(scores_with_scores,
    editing = 3, score_type = "Linear", colname = "x",
