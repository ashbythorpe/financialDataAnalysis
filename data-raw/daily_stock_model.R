## code to prepare `daily_stock_model` dataset goes here
library(tidyverse)
library(tidymodels)
library(modeltime)
library(bonsai)
...
tuned_wfset <- readRDS("tuned_wfset2.rds")
...
daily_stock_model <- fit_members(blended)

usethis::use_data(daily_stock_model, overwrite = TRUE)
