...
sk <- "sk_4b0c60c4c2654212b02edd378384bbd8"
...
saveRDS(combined_income, "combined_income.rds")

cash_flow <- map(sp500$ticker,
...
balance_sheet <- map(sp500$ticker,
...
combined_company <- readRDS("combined_company.rds")
combined_cash_flow <- readRDS("combined_cash_flow.rds")
combined_balance_sheet <- readRDS("combined_balance_sheet.rds")
combined_income <- readRDS("combined_income.rds")
combined_stats <- readRDS("combined_stats.rds")
